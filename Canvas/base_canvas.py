...
class BaseCanvas(HighlightCanvas):
    def __init__(self, master=None, cnf=None, **kw):
        ...
        # TODO Léo: pour éviter le bug graphique où le move_back_square est lancé et on clique sur un carré, je pourrai créer une nouveau mode de jeu auquel cliquer sur les carrés ne donne plus rien?
